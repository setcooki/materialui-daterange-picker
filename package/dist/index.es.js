    ...
    return (createElement(Paper, { square: true, elevation: 0, className: classes.root },
        createElement(Grid, { container: true },
            ...
            createElement(Grid, { key: idx, container: true, direction: "row", justify: "center" }, week.map(function (day) {
                ...
                return (createElement(Day, { key: dateFns_50(day, 'MM-DD-YYYY', { locale: de }), filled: isStart || isEnd, outlined: dateFns_102(day), highlighted: highlighted && !isRangeOneDay, disabled: !dateFns_85(date, day)
...
var Menu = function (props) {
    ...
    return (React__default.createElement(Paper, { elevation: 0 },
            ...
            React__default.createElement(Grid, null,
                React__default.createElement(Grid, { container: true, className: classes.header, alignItems: "center" },
                    React__default.createElement(Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(Typography, { variant: "subtitle1" }, startDate ? dateFns_50(startDate, 'MMMM DD, YYYY', { locale: de }) : 'Start Datum')),
                    React__default.createElement(Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(ArrowRightAlt$1, { color: "action" })),
                    React__default.createElement(Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(Typography, { variant: "subtitle1" }, endDate ? dateFns_50(endDate, 'MMMM DD, YYYY', { locale: de }) : 'End Datum'))),
...
var DateRangePickerExporter = function (props) {
    ...
    var jss = create(__assign(__assign({}, jssPreset()), { insertionPoint: mountPoint }));
    return (createElement(StylesProvider, { jss: jss, generateClassName: generateClassName },
        createElement(DateRangePickerWrapper, __assign({}, rest))));
};
