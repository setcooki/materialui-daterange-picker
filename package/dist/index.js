    ...
    return (React.createElement(core.Paper, { square: true, elevation: 0, className: classes.root },
        React.createElement(core.Grid, { container: true },
            ...
            React.createElement(core.Grid, { key: idx, container: true, direction: "row", justify: "center" }, week.map(function (day) {
                ...
                return (React.createElement(Day, { key: dateFns_50(day, 'MM-DD-YYYY', { locale: de }), filled: isStart || isEnd, outlined: dateFns_102(day), highlighted: highlighted && !isRangeOneDay, disabled: !dateFns_85(date, day)
...
var Menu = function (props) {
    ...
    return (React__default.createElement(core.Paper, { elevation: 0 },
            ...
            React__default.createElement(core.Grid, null,
                React__default.createElement(core.Grid, { container: true, className: classes.header, alignItems: "center" },
                    React__default.createElement(core.Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(core.Typography, { variant: "subtitle1" }, startDate ? dateFns_50(startDate, 'MMMM DD, YYYY', { locale: de }) : 'Start Datum')),
                    React__default.createElement(core.Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(ArrowRightAlt$1, { color: "action" })),
                    React__default.createElement(core.Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(core.Typography, { variant: "subtitle1" }, endDate ? dateFns_50(endDate, 'MMMM DD, YYYY', { locale: de }) : 'End Datum'))),
...
var DateRangePickerExporter = function (props) {
    var mountPoint = props.mountPoint, rest = __rest(props, ["mountPoint"]);
    var jss = create(__assign(__assign({}, styles.jssPreset()), { insertionPoint: mountPoint }));
    return (React.createElement(styles.StylesProvider, { jss: jss, generateClassName: generateClassName },
        React.createElement(DateRangePickerWrapper, __assign({}, rest))));
};
